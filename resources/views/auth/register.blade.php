<x-layout class="!px-0">
  <section class="flex">
    ...
    <form method="POST" action="/register"
      ...
      <x-input name='name' type="text" placeholder='Enter your name'>Name</x-input>
      <x-input name='username' type="text" placeholder='Enter your username'>Username</x-input>
      <x-input name='email' type="email" placeholder='Enter your email'>Email</x-input>
      <x-input name='password' type="password" placeholder='Enter your password'>Password</x-input>
      <x-input name='password_confirmation' type="password" placeholder='Confirm Password'>Confirm
        Password</x-input>
